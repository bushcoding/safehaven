...
export function LeafletMap({ pets, selectedPet, onPetSelect }: LeafletMapProps) {
        ...
        const marker = window.L.marker([pet.lat, pet.lng], { icon: customIcon })
          ...
          .bindPopup(
            ...
            <div style="min-width: 220px; max-width: 280px;">
              <h3 style="margin: 0 0 8px 0; font-weight: bold; color: #333;">${pet.name}</h3>
              ...
              ${pet.status !== "adoptado" ? `
                <div style="margin-top: 12px; padding-top: 8px; border-top: 1px solid #eee;">
                  <a href="${getWhatsAppLink(pet)}" target="_blank" rel="noopener noreferrer" 
                     style="
                       display: inline-flex; 
                       align-items: center; 
                       background: #25d366; 
              ...
              ` : ""}
              <p style="margin: 8px 0 4px 0; font-size: 12px; color: #666; text-align: center;">Haz clic en el marcador para ver más detalles</p>
            </div>
          `,
          )
          .on("click", () => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div ref={mapRef} className="w-full h-full rounded-lg" style={{ minHeight: '200px' }} />
